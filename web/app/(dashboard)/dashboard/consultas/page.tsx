...
export default function ConsultasPage() {
  return (
    <div>
      <h1 className="text-2xl font-semibold text-zinc-900 dark:text-white">Consultas</h1>
      <p className="text-zinc-500 dark:text-zinc-400 mt-1">Consultas recibidas de clientes.</p>
