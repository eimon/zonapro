...
export function UserMenu() {
  ...
  if (!token) {
    return (
      <Link
        href="/login"
        className="text-sm font-semibold bg-brand-green text-zinc-950 px-4 py-2 rounded-lg transition-[filter] duration-150 hover:brightness-110 active:brightness-95"
      >
        Ingresar
      </Link>
    );
